...
const UploadAssetForm = ({ courseId, onFetchAssets }) => {
  ...
  const handleChange = (e) => {
    ...
    if (name === "lecture_file") {
      ...
      if (fileSize > 5) {
        toast.error(
          "La taille du fichier est supérieure à 5 Mo. Assurez-vous que moins de 5 Mo.",
          {
            style: {
      ...
      <div className="row">
        ...
        <div className="col-md-6">
          <div className="form-group">
            ...
            <div className="form-text">
              Téléchargez une taille de fichier inférieure ou égale à 5 Mo !
            </div>
          </div>
        </div>
        ...
        <div className="col-12">
          ...
          >
            ...
            Télécharger l'élément <span></span>
