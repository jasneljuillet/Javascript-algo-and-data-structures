          ...
          <div className="row align-items-center">
            <div className="col-lg-6 col-md-12">
              <div className="feedback-content">
                ...
                <h2>
                  Étude flexible à votre rythme, selon à vos propres besoins.
                </h2>
                <p>
                  Avec Hagn, vous pouvez étudier quand et où vous le souhaitez.
                  choisir. Nous avons des étudiants dans tout le pays.
                </p>
