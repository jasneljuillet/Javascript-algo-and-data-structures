          ...
          <div className="courses-sidebar-information">
            <ul className="info">
              <li>
                <div className="d-flex justify-content-between align-items-center">
                  <span>
                    <i className="flaticon-play"></i> Cours en direct
                  </span>
                  {course.is_class ? (
              ...
              <li>
                <div className="d-flex justify-content-between align-items-center">
                  <span>
                    <i className="flaticon-teacher"></i> Instruct(eur/euse)
                  </span>
              ...
              <li>
                <div className="d-flex justify-content-between align-items-center">
                  <span>
                    <i className="flaticon-time"></i> Durée
                  </span>
                  {course.duration}
                </div>
              </li>
              <li>
                <div className="d-flex justify-content-between align-items-center">
                  <span>
                    <i className="flaticon-distance-learning"></i> Leçons
                  </span>
                  {course.lessons}
                </div>
              </li>
              <li>
                <div className="d-flex justify-content-between align-items-center">
                  <span>
                    <i className="flaticon-web"></i> Inscrit
                  </span>
                  {course.enrolments && course.enrolments.length} étudiants
                </div>
              </li>
              <li>
                <div className="d-flex justify-content-between align-items-center">
                  <span>
                    <i className="flaticon-html"></i> Langue
                  </span>
                  Français
                </div>
              </li>
              ...
              <li>
                <div className="d-flex justify-content-between align-items-center">
                  <span>
                    <i className="flaticon-lock"></i> Accéder
                  </span>
                  {course.access_time}
                </div>
              </li>
              <li>
                <div className="d-flex justify-content-between align-items-center">
                  <span>
                    <i className="flaticon-certification"></i> Certificat
                  </span>
                  Yes
                </div>
              </li>
            ...
            <div className="btn-box">
              {alreadyBuy ? (
                ...
                >
                  <i className="flaticon-shopping-cart"></i> Afficher mes cours
                  <span></span>
                </button>
              ) : (
                <>
                  {add ? (
                    <Link href="/checkout" className="default-btn">
                      <i className="flaticon-right-arrow"></i> Voir le panier
                    </Link>
                  ) : (
                    <button
                    ...
                    >
                      {" "}
                      <i className="flaticon-shopping-cart"></i> Ajouter au
                      panier
                      <span></span>
                    </button>
                  )}
