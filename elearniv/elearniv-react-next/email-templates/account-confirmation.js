...
export const confirmEmailAddress = async (user) => {
  ...
  const data = {
    to: user.email,
    from: "HAGN Cours en ligne <hello@envytheme.com>",
                        ...
                        <tr>
                            <td>
                                <div class="text" style="padding: 0 2.5em; text-align: left;">
                                    <h4>Ch(er/ère) ${user.first_name},</h4>
                                    <p>Merci de vous être inscrit sur notre notre plateform! Veuillez cliquer sur le lien ci-dessous pour vérifier votre adresse e-mail et activer votre compte.</p>
                                    <p><a href="${baseUrl}/confirm-email?token=${user.reset_password_token}&email=${user.email}" style="text-decoration: underline;">Confirmer mon adresse e-mail</a></p>

                                    <p>
                                        Salutations, <br />
                                        Équipe d'assistance <br />
