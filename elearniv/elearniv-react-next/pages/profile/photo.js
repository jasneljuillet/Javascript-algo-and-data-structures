...
const Photo = ({ user }) => {
  ...
  const handleChange = (e) => {
    ...
    if (profilePhotoSize > 2) {
      toast.error(
        "La taille de la photo de profil est supérieure à 2 Mo. Assurez-vous que moins de 2 Mo.",
        {
          style: {
    ...
    <div className="ptb-100">
      <div className="container">
        ...
        <ul className="nav-style1">
          ...
          <li>
            <Link href="/profile/photo" className="active">
              Image de profil
            </Link>
          </li>
        </ul>
              ...
              <div className="col-md-6">
                <div className="form-group">
                  ...
                  <div className="form-text mt-2">
                    Téléchargez une image de 200 x 200 pixels !
                  </div>
