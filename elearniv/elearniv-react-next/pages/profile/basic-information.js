  ...
  return <>
    ...
    <div className="ptb-100">
      <div className="container">
        <h2 className="fw-bold mb-4">Paramètres de profil</h2>

        <ul className="nav-style1">
          <li>
            <Link href="/profile/basic-information" className="active">
              Profil
            </Link>
          </li>
          <li>
              ...
              <div className="col-md-6">
                ...
                <div className="form-group">
                  ...
                  <p className="form-text mt-2">
                    Votre biographie doit contenir au moins 50 caractères, des
                    liens et les codes promo ne sont pas autorisés.
                  </p>
                </div>
                ...
                <div className="form-group" name="gender">
                  ...
                  <select className="form-select">
                    <option defaultValue="Male">Homme</option>
                    <option defaultValue="Female">Femme</option>
                  </select>
                </div>
              </div>
